...
static CURRENT_LANG: Lazy<RwLock<String>> = Lazy::new(|| RwLock::new("fr".to_string()));
...
static TRANSLATIONS: Lazy<HashMap<&'static str, HashMap<&'static str, &'static str>>> =
    Lazy::new(|| {
        ...
        fr.insert("settings_applied", "✓ Réglages appliqués");
        ...
        fr.insert(
            "note_disabled",
            "<b>Désactivé :</b> restaure les seuils d'origine du système",
        );
        ...
        en.insert("settings_applied", "✓ Settings applied");
        ...
        en.insert(
            "note_disabled",
            "<b>Disabled:</b> restores original system thresholds",
        );
...
pub fn set_language(lang: &str) {
    ...
    *CURRENT_LANG.write().unwrap() = normalized.to_string();
}
